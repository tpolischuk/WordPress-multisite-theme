...
<?php if ( $the_query->have_posts() ) : ?>
	...
	<?php ++$counter; ?>
	<?php if ($counter % 2 == 0 ) : ?>
    	<section class="post-list featured-list-section one-half teaser first">
    <?php else : ?>
    	<section class="post-list featured-list-section one-half teaser">
    <?php endif; ?>
        <article id="post-<?php the_ID(); ?>" <?php post_class( 'category-listing category-list-article' ); ?>>
			<div class="topics-featured-image height-cropped">
				<a href="<?php the_permalink(); ?>">
					<?php include 'inc/featured-image/600x300.php';  ?>
				</a>
			</div>
